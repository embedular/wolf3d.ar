...
extern const uint8_t *artdata[1 + (1 + T_ENDART6 - T_ENDART1)];
...
{
    (void) article;
    // TODO: is this useful on retroport?
#if 0
#ifdef JAPAN
    int snames[10] = {
        H_HELP1PIC,
...
#ifndef JAPAN
#ifdef ARTSEXTERN
int     endextern = 1; // T_ENDART1;
#ifndef SPEAR
int     helpextern = 0; // T_HELPART;
#endif
#endif
